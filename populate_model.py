...
from pizza_ml.models import Pizza, Ingredients
...
def populate():
 ...
 with open('pizza_toppings.csv', 'rb') as csvfile:
     ...
     for ingr in ingr_file:
         if ingr[0] == 'ingredient':
             ...
             print 'added ingredient is ', added_in
 ...
 with open('pizza_recipe.csv', 'rb') as csvfile:
     ...
     for pizza in ingr_file:
         ...
         print 'added pizza is:', added_pizza

def add_pizza(pizza_name, pizza_image, pizza_index):
    ...
    p = Pizza.objects.get_or_create(name=pizza_name, pic= pizza_image , index=pizza_index, ingredients=pizzas.get_ingr(pizza_index) )[0]
    p.save()
    return p

def add_ingredients(ingr_name, ingr_index):
 i = Ingredients.objects.get_or_create(name=ingr_name,index=ingr_index)
 i.save()
 return i
