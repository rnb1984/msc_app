...
formApp.controller('formController', function ($scope, $http ) {
    ...
    $scope.occupations = [{ code: 0, name:'student'},{ code: 1, name:'unemployed'},{ code: 2, name:'graduate unemployed'},{ code: 3, name:'graduate employed'},{ code: 4, name:'employed'},{ code: 5, name:'undisclosed'}];
